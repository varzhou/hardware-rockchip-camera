...
#define RESULT_UPDATE_WITH_VALUE_IF_NEED(tag, cnt, value) \
    ...
    RESULT_UPDATE_IF_NEED(ANDROID_CONTROL_ENABLE_ZSL);
    RESULT_UPDATE_IF_NEED(ANDROID_CONTROL_AF_SCENE_CHANGE);
    ...
    RESULT_UPDATE_IF_NEED(ANDROID_LENS_DISTORTION);
    ...
    RESULT_UPDATE_IF_NEED(ANDROID_DISTORTION_CORRECTION_MODE);
